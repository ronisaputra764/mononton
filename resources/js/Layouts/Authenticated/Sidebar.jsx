            ...
            <div className="flex flex-col p-[30px] pr-0 border-r border-gray-400 overflow-y-auto h-full">
                ...
                <div className="links flex flex-col mt-[60px] h-full gap-[50px]">
                    ...
                    <div>
                        ...
                        <Link href={route = "dashboard"} className={`side-link ${url.startsWith('/prototype/dashboard') ? 'active' : ''}`}>
                    ...
                    <div>
                        ...
                        <Link href={route = "subscription"} className={`side-link ${url.startsWith('/prototype/subscription') ? 'active' : ''}`}>
                            <svg width="24" height="24" viewBox="0 0 24     24" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fillRule="evenodd" clipRule="evenodd"
